...
| [18 — Model Supply Chain (L0)](docs/18-model-supply-chain.md) | *Planning · not built* — artifact scanning, provenance ledger, and load-time integrity monitoring for malicious model files (OWASP LLM05) |
